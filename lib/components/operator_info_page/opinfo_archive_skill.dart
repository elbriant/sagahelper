...
class OpinfoArchiveSkill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // TODO: maybe hold tap on elite, skill and mod to show cost material
    // do a tip show to say this ||
    return ProviderScope(
      overrides: [
        operatorContextProvider.overrideWithBuild(
          (ref, notifier) => OperatorContext(level: maxLv, maxLevel: maxLv, elite: elite),
        ),
      ],
      child: Padding(
