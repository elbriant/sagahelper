...
final operatorListProvider = FutureProvider<List<Operator>>((ref) async {
  ...
  ref.read(cacheProvider.notifier).update(
        (c) => c.copyWith(
          ...
          cachedBaseSkillTable:
              (jsonDecode(fileString[7]) as Map<String, dynamic>)["buffs"] as Map<String, dynamic>,
...
final filteredOperatorListProvider = FutureProvider<List<Operator>>((ref) async {
